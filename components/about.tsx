...
export function About() {
  ...
  return (
    <section id="about" className="py-32 bg-gray-900/30" ref={ref}>
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-light mb-6 text-gray-100 tracking-tight">About Me</h2>
          ...
          >
            <Card className="bg-gray-800/30 border-gray-700/50 backdrop-blur-sm">
              <CardContent className="p-10">
                <h3 className="text-2xl font-light mb-6 text-gray-200">Current Focus</h3>
                ...
                <h3 className="text-2xl font-light mb-6 text-gray-200">Philosophy</h3>
                <p className="text-gray-400 mb-8 leading-relaxed font-light">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="text-center p-6 bg-gray-700/20 rounded-lg border border-gray-700/30">
                    <div className="text-3xl font-light text-gray-200 mb-2">9.25</div>
                    <div className="text-sm text-gray-500 tracking-wide uppercase">CGPA</div>
                  </div>
                  <div className="text-center p-6 bg-gray-700/20 rounded-lg border border-gray-700/30">
                    <div className="text-3xl font-light text-gray-200 mb-2">5+</div>
